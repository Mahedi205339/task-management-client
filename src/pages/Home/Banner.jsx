            ...
            <div className="banner  object-fill h-[500px] md:h-[400px] lg:h-[600px] ">
                <div className='scale-x-[-1]   bg-gradient-to-r from-black to-transparent opacity-90 md:opacity-80 h-full '>
                    <div data-aos="fade-up"
                        data-aos-duration="3000" className='pt-10 md:pt-16 lg:pt-20 pl-9 text-left '>
                        ...
                        <Link to="/dashboard"> <button className='px-4 py-2 md:px-6 md:py-3 bg-cyan-600 hover:bg-cyan-800 text-white font-semibold rounded-lg'>
                            Let's Explore
                        </button></Link>
                    </div>
